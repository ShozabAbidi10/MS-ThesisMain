...
namespace HoloLensWithOpenCVForUnityExample
{
    ...
    public class HoloOnly : MonoBehaviour
    {
        ...
        readonly Scalar COLOR_GRAY = new Scalar(128, 128, 128, 255);

        Mat grayMat4Thread;

        #region RaycastParams

        public bool RayCastRequested = false;
        ...
        protected void Start()
        {
            ...
            CreateLabelCheck.text = string.Format("initialized");

            // Setting the default values of all toggle fields.
            ...
            // initializing the tracker. Where are using this tracker. 
        ...
        public void OnAirTapAcquired()
        {
            ...
            OnAirTapAcquiredCheck.text = string.Format("Recieved AirTap Gesture.");
        ...
        public void OnFrameMatAcquired(Mat grayMat, Matrix4x4 projectionMatrix, Matrix4x4 cameraToWorldMatrix, CameraIntrinsics cameraIntrinsics)
        {
            ...
            if (enableDetection && !isDetecting)
            {
                ...
                System.Threading.Tasks.Task.Run(() =>
                {
                    ...
                    Rect centreOfFrame = new Rect();
                    centreOfFrame.x = (grayMat4Thread.width()/2) - (100 / 2);
                    centreOfFrame.y = (grayMat4Thread.height()/2) - (50 / 2);
                    centreOfFrame.width = 200;
                    centreOfFrame.height = 100;
                    detectionResult.Add(centreOfFrame);
        ...
        private void ThreadWorker()
        {
            ...
            Rect centreOfFrame = new Rect(
                ((grayMat4Thread.width() / 2) - (100 / 2)),
                ((grayMat4Thread.height() / 2) - (50 / 2)),
                200,
                100
            );
...
/*#if UNITY_EDITOR
        ...
        public Vector3? DoRaycastOnSpatialMap(Transform cameraTransform, Vector3 recognitionCenterPos)
        {
            ...
            {
                //Debug.DrawRay(cameraTransform.position, (srecognitionCenterPos - cameraTransform.position)* 1000, Color.white);
        ...
        public GameObject CreateLabel(string text, Vector3 location)
        {
            ...
            CreateLabelCheck.text = string.Format("Inside CreateLabel");
            ...
            toolTip.ToolTipText = $"{text} {location.ToString()}";
